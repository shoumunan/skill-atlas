...
enum SkillSandbox {
    static var sandboxRoot: URL { AtlasPaths.root.appendingPathComponent("sandbox") }
    ...
    static func plan(for skill: Skill) -> Plan {
    ...
    static func materialize(_ plan: Plan, skill: Skill) throws {
    ...
    @MainActor
    @discardableResult
    static func run(skill: Skill, dryRunProbe: String? = nil) throws -> Plan {
        ...
        try SkillLauncher.openTerminalForSandbox(command: plan.command)
        return plan
    }
