...
enum HookTelemetry {
    static var eventsURL: URL { AtlasPaths.root.appendingPathComponent("usage-events.jsonl") }
    static var scriptURL: URL { AtlasPaths.root.appendingPathComponent("hooks/log-skill-use.sh") }
    static var settingsURL: URL { AtlasPaths.home.appendingPathComponent(".claude/settings.json") }
    static var backupsDir: URL { AtlasPaths.root.appendingPathComponent("settings-backups") }
    ...
    static func backup(_ data: Data, label: String = "user") throws {
        let fileManager = FileManager.default
    ...
    static func stats(nameToDirectory: [String: String]) -> [String: HookStats] {
